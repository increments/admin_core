...
RAILS_DEPENDENCY_VERSION = '>= 3.2'.freeze
...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'activerecord', RAILS_DEPENDENCY_VERSION
  spec.add_dependency 'activesupport', RAILS_DEPENDENCY_VERSION
  spec.add_dependency 'kaminari', '~> 1.0'

  spec.add_development_dependency 'bundler', '~> 1.12'
  spec.add_development_dependency 'database_cleaner', '~> 1.5'
  spec.add_development_dependency 'factory_girl', '~> 4.8'
  spec.add_development_dependency 'rails', RAILS_DEPENDENCY_VERSION
